...
INSERT INTO t5_user (username, password, name, email) VALUES
      ('USER1', '$2a$10$alIVxH0Moj9.xWGgDAJvsuthEOcR/CY7r8AwA2pKtZ13lp4LpRRM2', '회원1', 'user1@mail.com'),
      ('USER2', '$2a$10$JtQArNE0nzdJVsbqJnVO9.L1CsoBb6eT8sCyNHHLLOGrwvU/.hQe6', '회원2', 'user2@mail.com'),
      ('ADMIN1', '$2a$10$bg5471WLRM3NzlGmEbSusuWMVyulO4VE6tA.omboygxIpLN5dMtBi', '관리자1', 'admin1@mail.com')
;
